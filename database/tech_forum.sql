...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 20, 2019 at 03:03 PM
...
(40, '2019-04-12 06:14:55', 'hi how are you.?', 5, 21);
...
(14, 'Thread life cycle', 'What are the different stages of thread life cycle?\r\n', '2012-04-09 23:04:43', 9, 12, 190),
(15, 'applet controls ', 'how to create simple applet program? ', '2012-04-12 12:02:44', 9, 13, 7),
...
(42, 'Who is the father of php', 'Any one tell me who is the father of php ???????', '2015-10-25 07:12:11', 8, 12, 10),
(43, 'applet', 'how it works.?', '2019-04-08 18:12:54', 8, 13, 1),
(44, 'Thread Meaning', 'What is Thread?', '2019-04-12 06:17:16', 37, 12, 2),
(45, 'Operating System', 'What is Operating System? ', '2019-04-18 06:43:15', 38, 12, 2),
(46, 'isolated thread', 'what is dba?', '2019-06-10 13:34:57', 39, 13, 1),
(47, 'isolated thread', 'what is dth?', '2019-06-10 13:59:41', 40, 12, 0),
(48, 'isolated thread', 'what is dba?', '2019-06-10 14:06:06', 40, 13, 0),
(49, 'PHP', 'What is PHP database connectivity?', '2019-06-10 14:09:29', 40, 14, 0),
(50, 'Operating System', 'What is Kotlin?', '2019-11-13 07:38:40', 41, 19, 1);
...
(17, 'Operating System', 'Process Management'),
(18, 'Applet', 'JAVA'),
...
(5, 'U.S.A', 'Maharashtra', '-', 'admin', 'admin', 'administrator', 'admin', NULL, '2005-04-17', 'admin@gmail.com', '1', 'ups/admin.jpg', 1),
(41, 'India', 'maharashtra', 'gfgfghdf', 'user', 'aaa', 'aaa', 'aaa', NULL, '0000-00-00', 'aaa@gmail.com', '1', 'ups/Capture001.png', 0);
...
--
ALTER TABLE `chat`
  MODIFY `chatdetail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
--
...
--
ALTER TABLE `user`
  MODIFY `user_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;COMMIT;
